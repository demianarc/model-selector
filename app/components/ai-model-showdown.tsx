...
const providerLinks: { [key: string]: string } = {
  ...
  const data: DataItem[] = [
    ...
    { id: "213", creator: "AllenAI", provider: "Nebius AI", model: "OLMo-7B", name: "OLMo-7B-Instruct", contextWindow: 2000, pricePerMillionTokens: 120, inputPrice: 80, outputPrice: 240, outputSpeed: 25, latency: null, qualityIndex: 46 },
];
